...
as DateTime?,totalTypedJamos: null == totalTypedJamos ? _self.totalTypedJamos : totalTypedJamos // ignore: cast_nullable_to_non_nullable
as int,totalMistakes: null == totalMistakes ? _self.totalMistakes : totalMistakes // ignore: cast_nullable_to_non_nullable
as int,mistakeCharacters: null == mistakeCharacters ? _self.mistakeCharacters : mistakeCharacters // ignore: cast_nullable_to_non_nullable
as Map<String, int>,
  ));
}
/// Create a copy of RankingGameSessionState
...
// アニメーション用のタイムスタンプ
@override@JsonKey() final  int totalTypedJamos;
// 正解した字母数（統計用）
@override@JsonKey() final  int totalMistakes;
// ミス数（正解率計算用）
 final  Map<String, int> _mistakeCharacters;
// ミス数（正解率計算用）
@override@JsonKey() Map<String, int> get mistakeCharacters {
  if (_mistakeCharacters is EqualUnmodifiableMapView) return _mistakeCharacters;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_mistakeCharacters);
}
...
as DateTime?,totalTypedJamos: null == totalTypedJamos ? _self.totalTypedJamos : totalTypedJamos // ignore: cast_nullable_to_non_nullable
as int,totalMistakes: null == totalMistakes ? _self.totalMistakes : totalMistakes // ignore: cast_nullable_to_non_nullable
as int,mistakeCharacters: null == mistakeCharacters ? _self._mistakeCharacters : mistakeCharacters // ignore: cast_nullable_to_non_nullable
as Map<String, int>,
  ));
}
